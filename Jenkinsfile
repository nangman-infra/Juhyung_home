...
def REPO_SLUG = 'nangman-infra/Juhyung_home'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/Juhyung_home.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'Juhyung_home main push detected',
